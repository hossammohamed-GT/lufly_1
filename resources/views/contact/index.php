 ...
 * WhatsApp, email, factory address and pre-filled quick requests.
 *
...
$quickLinks = [
    ['key' => 'catalog', 'href' => $wa('Hello LUFLY, please send the 2026 Master Technical PDF Catalog.')],
    ['key' => 'bim', 'href' => $wa('Hello LUFLY, I require BIM and 3D Revit files for project specification.')],
    ['key' => 'quote', 'href' => $wa('Hello LUFLY Team, I would like to request direct factory pricing and project specifications for architectural sanitary ware.')],
];
?>
    ...
    <div class="cpage-inner">
        ...
        <div class="cpage-grid">
            ...
            <article class="cpage-card">
                <span class="cpage-card-icon" aria-hidden="true">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="22" height="22"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-10 6L2 7"/></svg>
                </span>
            ...
            <article class="cpage-card">
                <span class="cpage-card-icon" aria-hidden="true">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="22" height="22"><path d="M3 21h18"/><path d="M5 21V7l7-4 7 4v14"/><path d="M9 21v-6h6v6"/><path d="M9 10h.01M15 10h.01"/></svg>
                </span>
        ...
        <section class="cpage-quick" aria-label="<?= e(trans('contact.quick_title')) ?>">
            ...
            <div class="cpage-quick-row">
                <?php foreach ($quickLinks as $link): ?>
                    <a class="cpage-chip" href="<?= e($link['href']) ?>" target="_blank" rel="noopener noreferrer">
                        ...
                        <span><?= e(trans('contact.quick_' . $link['key'])) ?></span>
                    </a>
                <?php endforeach; ?>
            </div>
            <p class="cpage-note">
